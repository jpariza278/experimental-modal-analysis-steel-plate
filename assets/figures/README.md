...
| `05-representative-mode-shape.png` | `word/media/image20.png` | `Grâce à cette configuration, nous pouvons voir les quatre premiers modes propres` | A representative extracted mode shape (the report shows mode 4 at 99.2 Hz). A composite of several modes is also acceptable. | Identified mode shapes |
